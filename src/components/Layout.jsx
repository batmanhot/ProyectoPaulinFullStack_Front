...
const Layout = ({ children }) => {
    ...
    return (
        <div className="flex h-screen bg-gray-50 dark:bg-gray-900 overflow-hidden font-sans transition-colors duration-300">
            {/* Sidebar */}
            <aside className="w-64 flex-shrink-0 bg-gradient-to-b from-teal-400 to-blue-600 dark:from-gray-800 dark:to-gray-900 shadow-xl flex flex-col z-20 transition-colors duration-300">
                {/* Logo Area */}
                ...
                <nav className="flex-1 mt-6 space-y-1 overflow-y-auto">
                    ...
                    <Link to="/relacioncotizaciones" className={getLinkClass('/relacioncotizaciones')}>
            ...
            <div className="flex-1 flex flex-col overflow-hidden relative">
                ...
                {/* Top Header */}
                <header className="h-16 bg-white dark:bg-gray-800 shadow-sm flex items-center justify-between px-8 z-10 sticky top-0 transition-colors duration-300">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-2 cursor-pointer border-l pl-6 border-gray-200 dark:border-gray-700">
